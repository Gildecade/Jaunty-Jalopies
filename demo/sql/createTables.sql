...
CREATE TABLE Repair (
	...
	FOREIGN KEY (vin) REFERENCES Vehicle(vin),
	FOREIGN KEY (service_writer_username) REFERENCES User(username),
	FOREIGN KEY (customer_id) REFERENCES Customer(id),
...
CREATE TABLE Part (
	...
	FOREIGN KEY (vin) REFERENCES Repair(vin),
	FOREIGN KEY (start_date) REFERENCES Repair(start_date)
);
...
CREATE TABLE Sale(
	...
	FOREIGN KEY (vin) REFERENCES Vehicle(vin),
	FOREIGN KEY (salespeople_username) REFERENCES User(username),
	FOREIGN KEY (customer_id) REFERENCES Customer(id)
);
